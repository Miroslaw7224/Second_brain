...
export default function CTA() {
  return (
    <section
      className="bg-[var(--bg2)] px-6 pt-6 pb-24 sm:px-8 lg:px-12 xl:px-16 lg:pt-8 lg:pb-24 border-y border-[var(--border)]"
      id="cta"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-sm text-[var(--text3)]">Bez karty. Anuluj kiedy chcesz.</p>
