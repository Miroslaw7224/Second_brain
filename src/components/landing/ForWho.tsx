    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl font-bold text-[var(--text)] sm:text-4xl">Dla kogo</h2>
          <p className="mt-4 text-lg text-[var(--text2)]">
            Freelancerzy z wieloma klientami. Osoby, które chcą przestać gubić kontekst między
            projektami.
          </p>
          <p className="mt-8 font-semibold text-[var(--text)]">Dla Ciebie, jeśli…</p>
