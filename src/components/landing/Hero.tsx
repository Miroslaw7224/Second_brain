...
export default function Hero() {
  return (
    <section
      className="relative overflow-hidden bg-[var(--bg)] px-6 pt-16 pb-24 sm:px-8 lg:px-12 xl:px-16 lg:pb-24"
      id="hero"
    >
      <div className="mx-auto max-w-7xl text-center">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg text-[var(--text2)] sm:text-xl">
          Dla freelancerów z wieloma klientami: jedna baza dokumentów i notatek, rozmowa z AI po
          Twojej wiedzy — odpowiedzi w sekundach, ze wskazaniem źródła.
        </p>
        <div className="mt-10">
          <Link
            href="/auth/login"
