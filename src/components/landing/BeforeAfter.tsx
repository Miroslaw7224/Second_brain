  ...
  return (
    <section className="bg-slate-50 px-6 py-20 sm:px-8 lg:px-12 xl:px-16" id="przed-po">
      <div className="mx-auto max-w-7xl">
        <h2 className="text-center text-3xl font-bold text-slate-900 sm:text-4xl">Przed vs Po</h2>
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 text-left">
          ...
          <p className="mt-2 text-slate-800">
            ...
            <strong className="ml-1"> Odpowiedź:</strong> W marcu ustaliliście termin 15.04, budżet
            8000 zł. [Źródło: notatka z 12.03]
          </p>
        </div>
      </div>
    </section>
