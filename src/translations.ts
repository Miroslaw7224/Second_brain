...
export const translations = {
  en: {
    ...
    mindMapsExportHtmlTitle: "Download self-contained HTML file (offline)",
    mindMapsExportHtml: "Download HTML",
    mindMapsNewNode: "New node",
    mindMapsAIImportTreeAdd: "Add subtree via AI",
    mindMapsAIImportTreeModalTitle: "Add subtree via AI",
    mindMapsAIImportTreeInsert: "Insert into map",
  ...
  pl: {
    ...
    mindMapsExportHtmlTitle: "Pobierz mapę jako samowystarczalny plik HTML (offline)",
    mindMapsExportHtml: "Pobierz HTML",
    mindMapsNewNode: "Nowy węzeł",
    mindMapsAIImportTreeAdd: "Dodaj poddrzewo przez AI",
    mindMapsAIImportTreeModalTitle: "Dodaj poddrzewo przez AI",
    mindMapsAIImportTreeInsert: "Wstaw do mapy",
