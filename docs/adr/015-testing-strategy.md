...
tests/
  ...
  integration/
    services/
  e2e/          ← placeholder na przyszłość
  security/     ← placeholder na przyszłość
  fixtures/
    gemini-response.json
    firestore-chunks.json
  smoke/        ← opcjonalnie
```
...
### 3. Co testować i Definition of Done
...
### 9. Bezpieczeństwo (wzmianka na przyszłość)
